...
import { createDoctor, createHospital, IMedicalSpecialistsFormik } from "./actions";
...
const validationSchema = yup.object({
  ...
  cityId: yup.number().required('Hospital is required').notOneOf([0], 'Please select a hospital'),
});
